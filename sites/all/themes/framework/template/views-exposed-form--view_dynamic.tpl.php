    ...
    <?php foreach ($widgets as $id => $widget): ?>
      <?php if($m==1):?>
        ...
        <div class="selec_date"><label style="font-size: 14px;font-weight: bold">Select Date: </label><select style="height: 30px">
            ...
            <option value="3">Contract create Date</option>
            <option value="4">Due Date</option>
          </select></div>
    <?php endif;?>
      <div id="<?php print $widget->id; ?>-wrapper" class="<?php if($m >0) echo 'ngay_thang'; ?> views-exposed-widget views-widget-<?php print $id; ?>">
